...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://open-sea-global.alipay.com/ams/api/v1/payments/verifyAndCompletePayment';
    ...
    {
        $report  = 'PHP SDK (request) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://open-sea-global.alipay.com/ams/api/v1/payments/verifyAndCompletePayment",
