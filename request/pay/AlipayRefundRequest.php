...
class AlipayRefundRequest extends AlipayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        return $this->container['captureId'];
    }

    /**
     * Sets captureId
     *
     * @param string|null $captureId captureId
     *
     * @return self
     */
    public function setCaptureId($captureId)
    {
        $this->container['captureId'] = $captureId;

        return $this;
    }

    /**
     * Gets refundToBankInfo
     *
     * @return \model\RefundToBankInfo|null
     */
    public function getRefundToBankInfo()
    {
        return $this->container['refundToBankInfo'];
    }

    /**
     * Sets refundToBankInfo
     *
     * @param \model\RefundToBankInfo|null $refundToBankInfo refundToBankInfo
     *
     * @return self
     */
    public function setRefundToBankInfo($refundToBankInfo)
    {
        $this->container['refundToBankInfo'] = $refundToBankInfo;
