...
/**
 * AlipayCaptureRequest Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayCaptureRequest   extends AlipayRequest  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCaptureRequest';
    ...
    {
        $this->setIfExists('captureRequestId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['captureRequestId'] === null) {
            $invalidProperties[] = "'captureRequestId' can't be null";
        }
        if ($this->container['paymentId'] === null) {
            $invalidProperties[] = "'paymentId' can't be null";
        }
        if ($this->container['captureAmount'] === null) {
            $invalidProperties[] = "'captureAmount' can't be null";
        }
    ...
    /**
     * Gets captureRequestId
     *
     * @return string
     */
    public function getCaptureRequestId()
    {
        return $this->container['captureRequestId'];
    }
    ...
    {
        $this->container['captureRequestId'] = $captureRequestId;
    ...
    {
        return $this->container['captureAmount'];
    }
    ...
    {
        $this->container['captureAmount'] = $captureAmount;
    ...
    {
        return $this->container['isLastCapture'];
    }
