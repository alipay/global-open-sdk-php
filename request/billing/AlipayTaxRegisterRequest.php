...
/**
 * AlipayTaxRegisterRequest Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayTaxRegisterRequest   extends AlipayRequest  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayTaxRegisterRequest';
    ...
    protected static $getters = [
        'registrationRequestId' => 'getRegistrationRequestId',
        'taxType' => 'getTaxType',
    ...
    {
        $this->setIfExists('registrationRequestId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['registrationRequestId'] === null) {
            $invalidProperties[] = "'registrationRequestId' can't be null";
        }
        ...
        if ($this->container['registrationType'] === null) {
            $invalidProperties[] = "'registrationType' can't be null";
        }
        if ($this->container['taxId'] === null) {
            $invalidProperties[] = "'taxId' can't be null";
        }
        if ($this->container['activeFrom'] === null) {
            $invalidProperties[] = "'activeFrom' can't be null";
        }
    ...
    /**
     * Gets registrationRequestId
     *
     * @return string
     */
    public function getRegistrationRequestId()
    {
        return $this->container['registrationRequestId'];
    }
    ...
    {
        $this->container['registrationRequestId'] = $registrationRequestId;
     ...
     * Sets jurisdiction
     *
     * @param \model\TaxJurisdiction $jurisdiction jurisdiction
     *
     * @return self
     */
     ...
     * Sets taxId
     *
     * @param string $taxId The tax ID. Maximum length: 64 characters.
     *
     * @return self
     */
     ...
     * Sets activeFrom
     *
     * @param string $activeFrom The time from which the tax registration is active. Maximum length: 32 characters.
     *
     * @return self
     */
