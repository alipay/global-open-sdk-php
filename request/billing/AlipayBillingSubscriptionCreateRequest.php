...
class AlipayBillingSubscriptionCreateRequest   extends AlipayRequest  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets priceItems
     *
     * @param \model\PriceItem[] $priceItems List of PriceItem objects. At least 1 item is required; there is no maximum limit on the number of items (the previous maximum of 20 no longer applies)
     *
     * @return self
     */
