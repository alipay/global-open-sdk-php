...
/**
 * AlipaySubmitAttachmentRequest Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipaySubmitAttachmentRequest   extends AlipayRequest  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipaySubmitAttachmentRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fileSha256', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['submitAttachmentRequestId'] === null) {
            $invalidProperties[] = "'submitAttachmentRequestId' can't be null";
        }
        if ($this->container['attachmentType'] === null) {
            $invalidProperties[] = "'attachmentType' can't be null";
        }
        if ($this->container['fileSha256'] === null) {
            $invalidProperties[] = "'fileSha256' can't be null";
        }
