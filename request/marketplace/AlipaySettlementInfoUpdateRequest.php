...
/**
 * AlipaySettlementInfoUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipaySettlementInfoUpdateRequest   extends AlipayRequest  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipaySettlementInfoUpdateRequest';
    ...
    protected static $getters = [
        'updateRequestId' => 'getUpdateRequestId',
        'referenceMerchantId' => 'getReferenceMerchantId',
        'settlementCurrency' => 'getSettlementCurrency',
        'settlementBankAccount' => 'getSettlementBankAccount'
    ];
    ...
    {
        $this->setIfExists('updateRequestId', $data ?? [], null);
        $this->setIfExists('referenceMerchantId', $data ?? [], null);
        $this->setIfExists('settlementCurrency', $data ?? [], null);
        $this->setIfExists('settlementBankAccount', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['updateRequestId'] === null) {
            $invalidProperties[] = "'updateRequestId' can't be null";
        }
        if ($this->container['referenceMerchantId'] === null) {
            $invalidProperties[] = "'referenceMerchantId' can't be null";
        }
        if ($this->container['settlementCurrency'] === null) {
            $invalidProperties[] = "'settlementCurrency' can't be null";
        }
        if ($this->container['settlementBankAccount'] === null) {
            $invalidProperties[] = "'settlementBankAccount' can't be null";
        }
    ...
    /**
     * Gets updateRequestId
     *
     * @return string
     */
    public function getUpdateRequestId()
    {
        return $this->container['updateRequestId'];
    }
    ...
    {
        return $this->container['settlementBankAccount'];
    }
    ...
    {
        $this->container['settlementBankAccount'] = $settlementBankAccount;
