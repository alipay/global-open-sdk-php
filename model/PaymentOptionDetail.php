...
/**
 * PaymentOptionDetail Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class PaymentOptionDetail  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOptionDetail';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supportBanks'] === null) {
            $invalidProperties[] = "'supportBanks' can't be null";
        }
    ...
    {
        return $this->container['supportBanks'];
    }
