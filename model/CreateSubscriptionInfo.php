...
/**
 * CreateSubscriptionInfo Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class CreateSubscriptionInfo  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets allowRetry
     *
     * @param bool|null $allowRetry Whether to allow retry for PIX recurrence payments. Defaults to false when not provided.
     *
     * @return self
     */
     ...
     * Sets retryMode
     *
     * @param string|null $retryMode The retry mode. Valid values are MANUAL and AUTOMATIC. Defaults to MANUAL when allowRetry is true. Maximum length: 9 characters.
     *
     * @return self
     */
