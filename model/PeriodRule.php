 ...
 */
class PeriodRule  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PeriodRule';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['periodCount'] === null) {
            $invalidProperties[] = "'periodCount' can't be null";
        }
     ...
     * Sets period
     *
     * @param int|null $period Number of periods
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param \model\Amount|null $price price
     *
     * @return self
     */
     ...
     * Sets periodCount
     *
     * @param int $periodCount The number of period types within one subscription period. For example, if the value of periodType is MONTH and the value of periodCount is 2, it means that the subscription period is two months.    More information:  Value range: 1 - unlimited
     *
     * @return self
     */
