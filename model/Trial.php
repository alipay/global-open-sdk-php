...
class Trial  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'trialStartPeriod' => 'trialStartPeriod',
        'trialAmount' => 'trialAmount',
        'trialEndPeriod' => 'trialEndPeriod'
    ];
    ...
    protected static $setters = [
        'trialStartPeriod' => 'setTrialStartPeriod',
        'trialAmount' => 'setTrialAmount',
        'trialEndPeriod' => 'setTrialEndPeriod'
    ];
    ...
    protected static $getters = [
        'trialStartPeriod' => 'getTrialStartPeriod',
        'trialAmount' => 'getTrialAmount',
        'trialEndPeriod' => 'getTrialEndPeriod'
    ];
    ...
    {
        $this->setIfExists('trialStartPeriod', $data ?? [], null);
        $this->setIfExists('trialAmount', $data ?? [], null);
        $this->setIfExists('trialEndPeriod', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trialStartPeriod'] === null) {
            $invalidProperties[] = "'trialStartPeriod' can't be null";
        }
        if ($this->container['trialAmount'] === null) {
            $invalidProperties[] = "'trialAmount' can't be null";
        }
    ...
    /**
     * Gets trialStartPeriod
     *
     * @return int
     */
    public function getTrialStartPeriod()
    {
        return $this->container['trialStartPeriod'];
    }
    ...
    {
        return $this->container['trialAmount'];
    }
    ...
    {
        return $this->container['trialEndPeriod'];
    }
    ...
    {
        $this->container['trialEndPeriod'] = $trialEndPeriod;
