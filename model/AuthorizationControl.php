...
class AuthorizationControl  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $paymentPreferenceCurrencies The card-level ordered balance-consumption preference. For a whitelisted merchant, the stored list is returned when configured and this child field is omitted when no card-level preference is configured. For a non-whitelisted merchant, the parent cardDetail object is omitted.
     *
     * @return self
     */
