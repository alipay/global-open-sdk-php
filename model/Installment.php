...
class Installment  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supportCardBrands'] === null) {
            $invalidProperties[] = "'supportCardBrands' can't be null";
        }
    ...
    {
        return $this->container['supportCardBrands'];
    }

    /**
     * Sets supportCardBrands
     *
     * @param \request\model\SupportCardBrand[] $supportCardBrands The list of card brands that support the installment plans.    This parameter is returned when the value of paymentMethodType is CARD.
     *
     * @return self
     */
    public function setSupportCardBrands($supportCardBrands)
    {
        $this->container['supportCardBrands'] = $supportCardBrands;
     ...
     * Sets plans
     *
     * @param \request\model\Plan[] $plans The list of installment plans for payment methods that support installments.
     *
     * @return self
     */
