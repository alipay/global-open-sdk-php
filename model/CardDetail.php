 ...
 *
 * @category Class
 * @description The complete card-detail payload returned by inquireCardDetail.
 * @package  request
...
class CardDetail  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cardNickName
     *
     * @param string|null $cardNickName The user-defined card nickname.
     *
     * @return self
     */
     ...
     * Sets cardStatus
     *
     * @param string $cardStatus The current card status.
     *
     * @return self
     */
     ...
     * Sets maskedCardNo
     *
     * @param string $maskedCardNo The masked card number.
     *
     * @return self
     */
     ...
     * Sets cardBrand
     *
     * @param string $cardBrand The card network brand.
     *
     * @return self
     */
     ...
     * Sets createdTime
     *
     * @param string $createdTime The card creation time in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets updatedTime
     *
     * @param string $updatedTime The card update time in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string $purpose The purpose of the card.
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note The note supplied for the card application.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,string>|null $metadata Customer metadata in key-value format.
     *
     * @return self
     */
