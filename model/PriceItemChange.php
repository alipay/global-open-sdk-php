...
/**
 * PriceItemChange Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class PriceItemChange  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceItemChange';
    ...
    */
    ...
    {
        return $this->container['currentPriceId'];
    }

    /**
     * Sets currentPriceId
     *
     * @param string|null $currentPriceId The current price id. Maximum length: 64 characters. Note: See documentation for details.
     *
     * @return self
     */
    public function setCurrentPriceId($currentPriceId)
    {
        $this->container['currentPriceId'] = $currentPriceId;
    ...
    {
        return $this->container['newPriceId'];
    }

    /**
     * Sets newPriceId
     *
     * @param string|null $newPriceId The new price id. Maximum length: 64 characters. Note: See documentation for details.
     *
     * @return self
     */
    public function setNewPriceId($newPriceId)
    {
        $this->container['newPriceId'] = $newPriceId;
