...
/**
 * BillingSubscriptionUpdateTrialSettingsEndBehavior Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class BillingSubscriptionUpdateTrialSettingsEndBehavior  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingSubscriptionUpdateTrialSettingsEndBehavior';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['missingPaymentMethod'] === null) {
            $invalidProperties[] = "'missingPaymentMethod' can't be null";
        }
     ...
     *
     * @param string $missingPaymentMethod The missing payment method. Maximum length: 14 characters.
     *
     * @return self
     */
