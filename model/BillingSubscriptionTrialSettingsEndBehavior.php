...
/**
 * BillingSubscriptionTrialSettingsEndBehavior Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class BillingSubscriptionTrialSettingsEndBehavior  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingSubscriptionTrialSettingsEndBehavior';
    ...
    */
     ...
     *
     * @param string|null $missingPaymentMethod The behavior applied when the trial ends without an available payment method. Valid values are CANCEL, CREATE_INVOICE, and PAUSE. Maximum length: 14 characters.
     *
     * @return self
     */
