...
/**
 * TransferToDetail Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class TransferToDetail  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferToDetail';
    ...
    */
    ...
    {
        return $this->container['transferToMethod'];
    }
    ...
    {
        $this->container['transferToMethod'] = $transferToMethod;
    ...
    /**
     * Gets transferNotifyUrl
     *
     * @return string|null
     */
    public function getTransferNotifyUrl()
    {
        return $this->container['transferNotifyUrl'];
    }
    ...
    {
        $this->container['transferNotifyUrl'] = $transferNotifyUrl;
    ...
    {
        return $this->container['transferRemark'];
    }
