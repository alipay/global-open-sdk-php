...
class Goods  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets goodsImageUrl
     *
     * @param string|null $goodsImageUrl The URL of the goods image. When using KLARNA, this value is used to display the goods image in the payment method app and must not exceed 1024 characters.
     *
     * @return self
     */
    ...
    /**
     * Gets goodsDiscountAmount
     *
     * @return \model\Amount|null
     */
    public function getGoodsDiscountAmount()
    {
        return $this->container['goodsDiscountAmount'];
    }

    /**
     * Sets goodsDiscountAmount
     *
     * @param \model\Amount|null $goodsDiscountAmount goodsDiscountAmount
     *
     * @return self
     */
    ...
    {
        return $this->container['crossSell'];
    }

    /**
     * Sets crossSell
     *
     * @param \model\Goods|null $crossSell crossSell
     *
     * @return self
     */
