...
class Logo  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('logoName', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['logoName'] === null) {
            $invalidProperties[] = "'logoName' can't be null";
        }
    ...
    {
        return $this->container['logoName'];
    }
    ...
    {
        $this->container['logoName'] = $logoName;
