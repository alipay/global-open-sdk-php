...
class Attachment  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fileKey', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['attachmentName'] === null) {
            $invalidProperties[] = "'attachmentName' can't be null";
        }
        if ($this->container['fileKey'] === null) {
            $invalidProperties[] = "'fileKey' can't be null";
        }
