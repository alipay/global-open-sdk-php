...
class LineItem  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['creditNoteItemId'] === null) {
            $invalidProperties[] = "'creditNoteItemId' can't be null";
        }
        if ($this->container['type'] === null) {
            $invalidProperties[] = "'type' can't be null";
        }
        if ($this->container['itemAmount'] === null) {
            $invalidProperties[] = "'itemAmount' can't be null";
        }
     ...
     *
     * @param string $creditNoteItemId The credit note item id. Maximum length: 64 characters.
     *
     * @return self
     */
     ...
     * Sets invoiceItemId
     *
     * @param string|null $invoiceItemId The invoice item id. Maximum length: 64 characters. Note: See documentation for details.
     *
     * @return self
     */
     ...
     * Sets itemAmount
     *
     * @param \model\Amount $itemAmount itemAmount
     *
     * @return self
     */
