...
/**
 * CardholderInfo Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class CardholderInfo  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardholderInfo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['billAddress'] === null) {
            $invalidProperties[] = "'billAddress' can't be null";
        }
    ...
    {
        return $this->container['billAddress'];
    }

    /**
     * Sets billAddress
     *
     * @param \model\Address $billAddress billAddress
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName The name displayed on the card.
     *
     * @return self
     */
