...
/**
 * CreditNoteCreateItem Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class CreditNoteCreateItem  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteCreateItem';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The credit note item type. Valid values are INVOICE_LINE_ITEM and CUSTOM_LINE_ITEM. Maximum length: 32 characters.
     *
     * @return self
     */
     ...
     * Sets invoiceItemId
     *
     * @param string|null $invoiceItemId The invoice item ID. Required when type is INVOICE_LINE_ITEM. Maximum length: 64 characters.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The custom line item description. Required when type is CUSTOM_LINE_ITEM. Maximum length: 256 characters.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity to credit. For an INVOICE_LINE_ITEM, provide either quantity or itemAmount, but not both.
     *
     * @return self
     */
