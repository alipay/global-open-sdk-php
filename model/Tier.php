...
class Tier  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('upTo', $data ?? [], null);
        $this->setIfExists('unitAmount', $data ?? [], null);
        $this->setIfExists('flatAmount', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['upTo'];
    }

    /**
     * Sets upTo
     *
     * @param int|null $upTo The up to.
     *
     * @return self
     */
    public function setUpTo($upTo)
    {
        $this->container['upTo'] = $upTo;
    ...
    {
        return $this->container['flatAmount'];
    }

    /**
     * Sets flatAmount
     *
     * @param \model\Amount|null $flatAmount flatAmount
     *
     * @return self
     */
    public function setFlatAmount($flatAmount)
    {
        $this->container['flatAmount'] = $flatAmount;
