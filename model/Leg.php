...
class Leg  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets fareBasis
     *
     * @param string|null $fareBasis Fare basis code for this leg of the trip.
     *
     * @return self
     */
     ...
     * Sets couponNumber
     *
     * @param string|null $couponNumber Coupon number associated with this leg of the trip.
     *
     * @return self
     */
     ...
     * Sets flightNumber
     *
     * @param string|null $flightNumber Flight number for this leg of the trip.
     *
     * @return self
     */
