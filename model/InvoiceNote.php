 ...
 */
class InvoiceNote  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceNote';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('noteTime', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['noteTime'] === null) {
            $invalidProperties[] = "'noteTime' can't be null";
        }
    ...
    {
        return $this->container['noteTime'];
    }
    ...
    {
        $this->container['noteTime'] = $noteTime;
