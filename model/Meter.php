...
class Meter  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['meterId'] === null) {
            $invalidProperties[] = "'meterId' can't be null";
        }
        ...
        if ($this->container['valueKeyOverride'] === null) {
            $invalidProperties[] = "'valueKeyOverride' can't be null";
        }
