...
class TaxBreakdown  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxBreakdown';
    ...
    protected static $setters = [
        ...
        'taxabilityReason' => 'setTaxabilityReason',
    ...
    protected static $getters = [
        ...
        'taxabilityReason' => 'getTaxabilityReason',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('taxabilityReason', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taxableAmount'] === null) {
            $invalidProperties[] = "'taxableAmount' can't be null";
        }
        if ($this->container['taxabilityReason'] === null) {
            $invalidProperties[] = "'taxabilityReason' can't be null";
        }
     ...
     * Sets taxRate
     *
     * @param string $taxRate The tax rate. Maximum length: 16 characters.
     *
     * @return self
     */
     ...
     * Sets taxableAmount
     *
     * @param \model\Amount $taxableAmount taxableAmount
     *
     * @return self
     */
    ...
    /**
     * Gets taxabilityReason
     *
     * @return string
     */
    public function getTaxabilityReason()
    {
        return $this->container['taxabilityReason'];
    }

    /**
     * Sets taxabilityReason
     *
     * @param string $taxabilityReason The taxability reason. Supported values are NOT_COLLECTING, PRODUCT_EXEMPT, REVERSE_CHARGE, CUSTOMER_EXEMPT, NOT_SUPPORTED, NOT_SUBJECT_TO_TAX, PRODUCT_EXEMPT_HOLIDAY, PORTION_PRODUCT_EXEMPT, ZERO_RATED, STANDARD_RATED, and UNKNOWN_ZERO_TAX.
     *
     * @return self
     */
    public function setTaxabilityReason($taxabilityReason)
    {
        $this->container['taxabilityReason'] = $taxabilityReason;
     ...
     * Sets inclusive
     *
     * @param bool $inclusive Indicates whether the tax is inclusive.
     *
     * @return self
     */
