 ...
 */
class RiskSignal  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignal';
    ...
    {
        $this->setIfExists('riskCode', $data ?? [], null);
        $this->setIfExists('riskReason', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['riskReason'] === null) {
            $invalidProperties[] = "'riskReason' can't be null";
        }
    ...
    {
        return $this->container['riskReason'];
    }
     ...
     * @return self
     */
    public function setRiskReason($riskReason)
    {
        $this->container['riskReason'] = $riskReason;
