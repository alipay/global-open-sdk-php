...
class SubscriptionPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $allowAccumulate Whether to allow accumulation of unused amounts
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscriptionStartTime Start time of the subscription plan in ISO 8601 format
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscriptionNotificationUrl URL for subscription notifications
     *
     * @return self
     */
