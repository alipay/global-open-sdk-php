...
/**
 * TaxCalculationLineItem Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class TaxCalculationLineItem  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxCalculationLineItem';
    ...
    */
     ...
     * Sets taxCode
     *
     * @param string|null $taxCode The tax code. Maximum length: 32 characters. Note: See documentation for details.
     *
     * @return self
     */
     ...
     * Sets productId
     *
     * @param string|null $productId The product ID. Maximum length: 64 characters. Note: See documentation for details.
     *
     * @return self
     */
     ...
     * Sets taxBehavior
     *
     * @param string|null $taxBehavior The tax behavior. Maximum length: 16 characters. Note: See documentation for details.
     *
     * @return self
     */
