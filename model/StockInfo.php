 ...
 */
class StockInfo  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockInfo';
    ...
    {
        $this->setIfExists('listedRegion', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['listedRegion'] === null) {
            $invalidProperties[] = "'listedRegion' can't be null";
        }
    ...
    {
        return $this->container['listedRegion'];
    }
    ...
    {
        $this->container['listedRegion'] = $listedRegion;
