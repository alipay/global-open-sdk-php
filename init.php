...
require __DIR__ . '/client/RequestTransportResolver.php';
require __DIR__ . '/client/UploadGatewayResolver.php';
require __DIR__ . '/client/ApiKeyAuth.php';
require __DIR__ . '/client/ApiKeyAlipayClient.php';
require __DIR__ . '/client/Http2JsonTransport.php';
require __DIR__ . '/client/MultipartHttpRPC.php';
require __DIR__ . '/client/SessionHttp2Executor.php';
require __DIR__ . '/client/FileUploadExecutor.php';
