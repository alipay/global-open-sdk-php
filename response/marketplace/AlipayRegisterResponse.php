...
/**
 * AlipayRegisterResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayRegisterResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayRegisterResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('registrationStatus', $data ?? [], null);
