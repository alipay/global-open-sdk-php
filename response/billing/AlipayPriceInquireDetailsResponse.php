...
/**
 * AlipayPriceInquireDetailsResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayPriceInquireDetailsResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayPriceInquireDetailsResponse';
    ...
    */
     ...
     * Sets priceId
     *
     * @param string|null $priceId System-generated price ID Returned only when result.resultCode is SUCCESS.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param string|null $metadata Custom key-value metadata. O - May be null in the response when the value is not set The value must be a valid JSON object string. Returned only when result.resultCode is SUCCESS.
     *
     * @return self
     */
