...
/**
 * AlipayCreditNoteCreateResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayCreditNoteCreateResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCreditNoteCreateResponse';
    ...
    */
     ...
     * Sets effectiveDate
     *
     * @param string|null $effectiveDate The effective date. Note: See documentation for details.
     *
     * @return self
     */
     ...
     * Sets createdAt
     *
     * @param string|null $createdAt The created at. Note: See documentation for details.
     *
     * @return self
     */
