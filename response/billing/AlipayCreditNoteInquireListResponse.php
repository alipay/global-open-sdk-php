...
/**
 * AlipayCreditNoteInquireListResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayCreditNoteInquireListResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCreditNoteInquireListResponse';
    ...
    */
     ...
     * Gets list
     *
     * @return \model\CreditNoteSummary[]|null
     */
     ...
     * Sets list
     *
     * @param \model\CreditNoteSummary[]|null $list The list. Note: See documentation for details.
     *
     * @return self
     */
