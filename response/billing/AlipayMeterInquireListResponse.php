...
/**
 * AlipayMeterInquireListResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayMeterInquireListResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMeterInquireListResponse';
    ...
    */
     ...
     * Sets totalCount
     *
     * @param int $totalCount The real-time number of matching Meter resources at query time.
     *
     * @return self
     */
     ...
     * Sets meters
     *
     * @param \model\Meter[] $meters The Meter list. Maximum size: 100 elements, bounded by pageSize.
     *
     * @return self
     */
