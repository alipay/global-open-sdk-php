...
/**
 * AlipayVaultingQueryResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayVaultingQueryResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayVaultingQueryResponse';
    ...
    */
     ...
     * @return string|null
     */
    public function getVaultingStatus()
    {
        return $this->container['vaultingStatus'];
    }
     ...
     * @return self
     */
    public function setVaultingStatus($vaultingStatus)
    {
        $this->container['vaultingStatus'] = $vaultingStatus;
