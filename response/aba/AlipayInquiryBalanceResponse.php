...
/**
 * AlipayInquiryBalanceResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayInquiryBalanceResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayInquiryBalanceResponse';
    ...
    {
        $this->setIfExists('accountBalances', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountBalances'] === null) {
            $invalidProperties[] = "'accountBalances' can't be null";
        }
     ...
     *
     * @param \model\AccountBalance[] $accountBalances accountBalances
     *
     * @return self
     */
