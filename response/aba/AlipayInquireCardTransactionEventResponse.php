...
/**
 * AlipayInquireCardTransactionEventResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayInquireCardTransactionEventResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayInquireCardTransactionEventResponse';
    ...
    */
     ...
     * Sets events
     *
     * @param \model\CardTransactionEvent[]|null $events The card transaction events. Returned when resultStatus is S; an empty match returns an empty array.
     *
     * @return self
     */
