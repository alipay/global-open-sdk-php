...
/**
 * AlipayInquireDirectPaymentResponse Class Doc Comment
 *
 * @category Class
 * @package  request
 ...
 */
class AlipayInquireDirectPaymentResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayInquireDirectPaymentResponse';
    ...
    */
     ...
     *
     * @param string|null $paymentResultCode The result code for different payment statuses. Possible payment result codes are listed in the Payment result codes table.  Note: This field is returned when the API is called successfully (the value of result.resultStatus is S).  More information:  Maximum length: 64 characters
     *
     * @return self
     */
     ...
     * Sets paymentId
     *
     * @param string $paymentId The unique ID that is assigned by Antom to identify a payment.  Note: This field is returned when the API is called successfully (the value of result.resultStatus is S).  More information:  Maximum length: 64 characters
     *
     * @return self
     */
     ...
     *
     * @param string $paymentRequestId The unique ID that is assigned by a merchant to identify a payment request.  Note: This field is returned when the API is called successfully (the value of result.resultStatus is S).  More information:  Maximum length: 64 characters
     *
     * @return self
     */
     ...
     * Sets payToAmount
     *
     * @param \model\Amount|null $payToAmount payToAmount
     *
     * @return self
     */
