...
class AlipayInquireCardResponse  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cardList
     *
     * @param \model\AbaCard[] $cardList 卡列表 此字段只有当 result.resultStatus = S 时才会按需返回。  Card list This field will only be returned as needed when `result.resultStatus = S`.
     *
     * @return self
     */
